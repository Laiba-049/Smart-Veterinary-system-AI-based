...
<nav class="navbar navbar-expand-lg bg-white navbar-light shadow-sm py-3 py-lg-0 px-3 px-lg-0 mb-5">
    ...
    <div class="collapse navbar-collapse" id="navbarCollapse">
        <div class="navbar-nav ms-auto py-0">
            ...
            <a href="{{ url('/contact') }}" class="nav-item nav-link nav-contact bg-primary text-white px-5 ms-lg-5">
            ...
            <div class="col-lg-7">
                <div class="owl-carousel testimonial-carousel bg-white p-5">
                    ...
                    <div class="testimonial-item text-center">
                        ...
                        <p>Dolores sed duo clita tempor justo dolor et stet lorem kasd labore dolore lorem ipsum.</p>
    ...
    <div class="container pt-5">
        <div class="row g-5">
            ...
            <div class="col-lg-3 col-md-6">
                ...
                <p class="mb-2"><i class="bi bi-geo-alt text-primary me-2"></i>123 Street, New York</p>
                <p class="mb-2"><i class="bi bi-envelope-open text-primary me-2"></i>info@example.com</p>
                <p class="mb-0"><i class="bi bi-telephone text-primary me-2"></i>+012 345 67890</p>
            </div>

            <div class="col-12 text-center text-body">
                <p class="mb-0">&copy; {{ date('Y') }} Pet Shop. All Rights Reserved.</p>
            </div>
